...
export default function CustomLoadingPage() {
  ...
  if (typeof window !== "undefined") {
    CenterHeight = window.innerHeight > 640 ? (window.innerHeight) / 2 - 160 - 20 : (window.innerHeight) / 2 - 64 - 20;
    CenterWidth = window.innerWidth > 1280 ? (window.innerWidth) / 2 - 384 - 18 :
  ...
  return (
    ...
    >
      <div className="relative w-full flex flex-col space-y-4">
        ...
        >
          {/* Add all inner components and animations */}
        </motion.div>
